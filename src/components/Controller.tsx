...
export const Controller: React.FC<ControllerProps> = ({
  ...
  return (
    <div className="flex-shrink-0 p-3 pb-[calc(24px+env(safe-area-inset-bottom))] md:p-6 md:pb-[calc(28px+env(safe-area-inset-bottom))] bg-white/90 dark:bg-[#141414]/90 backdrop-blur-2xl border-t border-black/5 dark:border-white/5 z-40 transition-all duration-300">
